        ...
        <div className="flex flex-col justify-center items-center gap-4 md:gap-[60px] text-center ">
            ...
            <div className="flex flex-wrap items-center justify-center w-screen gap-[60px] lg:justify-around px-2.5 md:px-10 lg:px-24">
                <div className="flex flex-col items-center gap-[10px] lg:gap-[33px] w-[270px] md:w-[350px]">
                    <img src="/magnify.svg" alt="magnify" className="h-[100px] md:h-[150px] lg:h-[200px]"/>
                ...
                <div className="flex flex-col items-center gap-[10px] lg:gap-[33px] w-[270px] md:w-[350px]">
                    <img src="/computer.svg" alt="computer" className="h-[100px] md:h-[150px] lg:h-[200px]"/>
                    <div className="flex flex-col items-center md:gap-[10px]">
                ...
                <div className="flex flex-col items-center gap-[10px] lg:gap-[33px] w-[270px] md:w-[350px]">
                    <img src="/hat.svg" alt="hat" className="h-[100px] md:h-[150px] lg:h-[200px]"/>
                    <div className="flex flex-col items-center md:gap-[10px]">
